...
const string OPTION_DESCRIPTIONS[NUM_OPTIONS] =
{
    ...
    "When dumping memory, display values as signed ints (-128 - 127).",
    "When dumping memory, display values as unsigned ints (0 - 255). This is the default setting.",
    "Show a performance report after execution.",
    "Quiet (no output). Also suppresses memory dumping by the * command.",
    "Ignore input (all get commands return EOF).",
